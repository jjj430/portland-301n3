...
(function(module){
    ...
    // TODO/DONE: Refactor this function, and provide it with a parameter of a callback function
    ...
    Article.fetchAll = function(callback) {
      if (localStorage.rawData) {
          console.log('loclaStorage exists');
    ...
    // TODO/DONE: Chain together a `map` and a `reduce` call to produce an array of unique author names.
    ...
    Article.numWordsByAuthor = function() {
      // TODO/DONE: Transform each author string into an object with 2 properties: One for
